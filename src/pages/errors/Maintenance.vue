<template>
  <q-page class="simple-page flex column items-center justify-center text-center">
    <div class="error-card">
      <q-icon name="engineering" color="primary" size="56px" />
      <div class="text-h5 text-weight-bold q-mt-md">Onderhoud actief</div>
      <div class="text-body1 text-grey-8 q-mt-sm">
        De service is tijdelijk niet beschikbaar door onderhoud. Probeer het zo opnieuw.
      </div>
...
const retryLaunch = async () => {
  if (currentFlow.value?.name === 'maintenance') {
    return
  }
